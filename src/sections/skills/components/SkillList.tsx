import { Copy, ChevronRight, FileCode } from 'lucide-react'
...
export function SkillList({ items, onSelect, onCopy }: SkillListProps) {
  return (
            ...
            >
              ...
              >
                ...
                <div className="flex items-center gap-1.5 text-zinc-400 dark:text-zinc-500">
                  ...
                  <span className="text-xs">{item.fileCount}</span>
                </div>
